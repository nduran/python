...
class Fondo(pygame.sprite.Sprite): #Creamos la clase Fondo
    ...
    def actualizar(self,screen,vx,vy): #Creamos el metodo update que actualiza constantemente las variables de 00movimiento y de pintar
        self.rect.move_ip(-vx,-vy) #el fonfo de mueve de su lugar -vx en el eje x  y -vy en el eje y
